...
namespace MediaDesktop
{
    ...
    internal class Validation
    {
        ...
        {
            List<IntPtr> progManHandles = APIsPackaged.FindProgramManagers();
            foreach (IntPtr progManHandle in progManHandles)
            {
               Process explorerProcess =  APIsPackaged.GetProcessByWindowHandle(progManHandle);
        ...
        public static IntPtr GetWorkerWWindow()
        {
            ...
            List<IntPtr> workerWHanles = APIsPackaged.FindWorkerWs();
